    ...
    <div className="min-h-screen bg-red-50">
      ...
      <div className="bg-gradient-to-r from-red-500 to-rose-400 text-white px-6 py-10 text-center">
        ...
        <p className="text-red-100">
          Dermatologists near you in <span className="font-bold">{city}</span>
        </p>
      </div>
      ...
      {!loading && (
        <div className="max-w-2xl mx-auto px-6 py-8 space-y-4">
          {doctors.map((doc, i) => (
            <div key={i}
              className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-red-400">
              ...
              <p className="text-gray-500 text-sm mb-4">📞 {doc.contact}</p>
              <a>
